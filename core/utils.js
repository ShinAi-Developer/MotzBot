...
async function botEffects(settings) {
...
globalThis.botLabel = function botLabel(text) {
	const { botBehavior } = require("./../settings/botConfig");
	const label = botBehavior.botLabel;
	return `${label} ${text}`;
};
